...
import { MOVIES_CATEGORIES, ORIGINAL_IMG_BASE_URL,TV_CATEGORIES } from "../../utils/constants";
...
const HomeScreen = () => {
  ...
  if(!trendingContent) return (
    <div className="h-screen text-white relative">
      <Navbar />
      <div className="absolute top-0 left-0 w-full h-full bg-black/70 flex items-center justify-content -z-10 shimmer " />
    </div>
  );
  ...
  return (
    ...
    <div className="relative h-screen text-white ">
      ...
      <img src={ORIGINAL_IMG_BASE_URL +trendingContent?.backdrop_path} alt="Hero image" className="absolute top-0 left-0 w-full h-full object-cover -z-50" />
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32">
        ...
        <div className="flex mt-8">
          ...
          <Link to={`/watch/${trendingContent?.id}`} className="bg-gray-500/70 hover:bg-grey-500 text-white py-2 px-4 rounded flex items-center">
